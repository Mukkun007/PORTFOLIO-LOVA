...
const Biographie = () => {
  ...
  return (
    <>
      <div className="biographie flex flex-wrap ml-[40px] 2xl:ml[100px] mr-[40px] 2xl:mr[100px] mt-[5rem] sm:mt-[5rem] md:mt-[6rem] 2xl:ml-[140px] 2xl:mr-[140px] md:justify-center">
