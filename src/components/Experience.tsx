  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#0f172a] mt-10">
      <div className="relative w-1/2">
        {/* Ligne verticale */}
        <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-[#265b6b] h-full"></div>
        ...
        {experiences.map((exp, index) => (
          ...
          >
            {/* Cercle avec icône */}
            <div className="w-[70px] h-[70px] bg-[#265b6b] rounded-full flex items-center justify-center text-white text-2xl absolute left-1/2 transform -translate-x-1/2">
              {exp.icon}
            </div>
