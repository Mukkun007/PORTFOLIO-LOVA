...
const Experience = () => {
  ...
  return (
    <>
      <div>
        <h1 className="font-bold text-center mt-5 lg:mt-8 xl:mt-10 text-3xl sm:text-[40px] md:text-[35px] lg:text-[40px] xl:text-3xl 2xl:text-[40px] text-white ml-[40px] mr-[40px]">
          {t("experience.title")}
        </h1>
      </div>
